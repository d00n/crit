configatron.default_mce_options = {
    ...
    :menubar => false,
    :statusbar => false,
    :toolbar => 'undo redo code | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link unlink image media',
    :plugins => %w{media link image preview autosave emoticons paste autoresize code table},
...
configatron.simple_mce_options = {
    ...
    :menubar => false,
    :statusbar => false,
    :toolbar => 'bold italic| bullist numlist | link unlink image',
